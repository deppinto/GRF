...
int main(){
    ...
    for(int start=1; start<=last; start++){
      ...
      //string access_dados="/home/diogo/MEGA/cenas/CellGPU/Results_glass/scripts"+to_string(scriptsIni)+"/dados.txt";
      //string access_dados="/home/diogo/CellGPU/SPV/Results/scripts"+to_string(scriptsIni)+"/dados.txt";
	...
	file>> v1 >> v2 >> v3 >> v4 >> v5 >> v6 >> v7 >> v8 >> v9 >> v10 >> v11;
      ...
      //sprintf(data, "/home/diogo/CellGPU/SPV/Results/scripts%d/Job_%d/test_voronoi.nc", scriptsIni, (start-1)*v11+1);
	...
	//	vector <double> t0_2 (LA*total_size, 0);
	    ...
	    //sprintf(dataname, "/media/hdd/Results/GPU/scripts5/Job_%d/test_voronoi_St%d_T%g_Iv%g_P%g_A%g_V%g.nc", avg, v9, v10, v11, v6, v7, v8);
            ...
            //sprintf(dataname, "/home/diogo/CellGPU/SPV/Results/scripts%d/Job_%d/test_voronoi.nc", scriptsIni, avg);
	    ...
	    //sprintf(dataname, "test_voronoi_St2_T1e+09_Iv0_P3.8_A1_V0.1.nc");
            //printf("%s\n",dataname);
		...
		//filename="/home/diogo/MEGA/cenas/CFTC_Cluster/Results_tissues/Glass/GPU/s1/MSD_"+to_string(start)+".txt";
                //filename="/home/diogo/CellGPU/SPV/Results/s"+to_string(scriptsIni)+"/MSD_"+to_string(start)+".txt";
		//filename="/home/diogo/MEGA/cenas/CFTC_Cluster/Results_tissues/GRF/s"+to_string(scriptsIni)+"/MSD_"+to_string(start) +".txt";
		filename="/mnt/c/Users/Diogop/Documents/MEGA/cenas/CFTC_Cluster/Results_tissues/GRF/s"+to_string(scriptsIni)+"/MSD_"+to_string(start) +".txt";
                ofstream file1;
                file1.open (filename);
		int last=0;
		...
		//filename="/home/diogo/MEGA/cenas/CFTC_Cluster/Results_tissues/GRF/s"+to_string(scriptsIni)+"/Diff.txt";
		filename="/mnt/c/Users/Diogop/Documents/MEGA/cenas/CFTC_Cluster/Results_tissues/GRF/s"+to_string(scriptsIni)+"/Diff.txt";
                file1.open (filename, std::ios_base::app);
		file1 << MSD[last]  <<" "<< MSD[last]/(4*dt*last) << " " << v1 << " "<< v6 <<" "<< v8 <<" "<< v9 <<" "<< v10*sqrt(v1)/1024 << endl;
                file1.close();
            }
        }
    }
