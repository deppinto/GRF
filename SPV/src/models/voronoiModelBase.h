...
class voronoiModelBase : public Simple2DActiveCell
    ...
    public:
        ...
        */
        ...
        void setSubstratePreferences(int SubIntType, double IncrementationValue, int dx, double sigmac);
        //!Set substrate preferences
        void setSubstratePreferencesRnd(int SubIntType, double mean, int dx, double sigma, int radius);
        //!Set cell area and perimeter preferences according to substrate interaction
        void setCellPreferencesSubstrate(double A0, double P0, bool ChangeArea, int dx);
        ...
        void movePointsSubstrateCPU(GPUArray<double2> &displacements,double scale);
        //!move particles on the GPU with substrate interactions
        void movePointsSubstrate(GPUArray<double2> &displacements,double scale);
    ...
    protected:
        ...
        */
        ...
        //!Save the value the cell is adapting to
        GPUArray<double> CellTime;
        //!Save substrate interaction properties
        GPUArray<double> SubstrateInteractions;
        //!Save substrate grid
        GPUArray<double> SubstrateGrid;
